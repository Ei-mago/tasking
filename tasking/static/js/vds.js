    ...
    1: [function (t, e, r) {
        ...
        i = t("cookie"), n = function () {
            ...
            return t.get = function (t) {
                ...
                return i.setItem(t, e, r, "/ticket/", window.location.hostname)
        ...
        if (t("./shim"), i = t("./tracker"), n = t("./dom_observer"), m = t("./utils"), h = t("./guid"), u = [], c = new n, v = new i(c), window._gr_support_circle_pop_out = !0, a = function () {
            ...
            }, -1 === m.indexOf(["", "", "127.0.0.1/ticket/"], window.location.hostname) && v.connect(d(o))
        }
        ...
        var n = /^(\.co\.|\.com\.|\.org\.|\.edu\.|\.net\.)/, i = {
            getItem: function (t) {
                ...
                for (var t = document.cookie.replace(/((?:^|\s*;)[^\=]+)(?=;|$)|^\s*|\s*(?:\=[^;]*)?(?:\1|$)/g, "").split(/\s*(?:\=[^;]*)?;\s*/),
                         e = t.length, r = 0; e > r; r++)t[r] = decodeURIComponent(t[r]);
                return t
            }
        }, o = {
        ...
        var h = function () {
            ...
            return t.prototype.processMutations = function () {
                if (this.treeChanges.anyParentsChanged || this.treeChanges.anyAttributesChanged)for (var t = this.treeChanges.keys(),
                                                                                                         e = 0; e < t.length; e++)this.visitNode(t[e], void 0)
                ...
                if (!this.childListChangeMap) {
                    ...
                    for (var e = 0; e < this.mutations.length; e++) {
                        ...
                        if ("childList" == r.type && (this.treeChanges.reachabilityChange(r.target) === d.STAYED_IN || this.calcOldPreviousSibling)) {
                            for (var n = this.getChildlistChange(r.target), i = r.previousSibling,
                                     o = 0; o < r.removedNodes.length; o++) {
            ...
            return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                ...
                for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3,
                         p = 4, f = 5, g = 6, b = 7, y = 8, S = 9, C = 10, O = 11, N = 12, x = 13, I = 14, E = c,
                         A = 0; A < e.length;) {
                    var D = e[A++];
                    switch (E) {
                        case c:
            ...
            return t.createObserverOptions = function (t) {
                ...
                for (var e = new f(this.root, t, this.elementFilter, this.calcReordered, this.options.oldPreviousSibling),
                         r = [], n = 0; n < this.options.queries.length; n++)r.push(new g(e, this.options.queries[n]));
                return r
                ...
                return t.prototype.disconnect = function () {
                    ...
                    if (void 0 === e) {
                        ...
                        for (var c = t.parentElement; c && "BODY" !== c.tagName && "HTML" !== c.tagName;) {
                            ...
                            if (l && null === l.match(/^[0-9]/) && (h += "#" + l), c.hasAttribute("class"))for (var p = c.getAttribute("class").trim().split(/\s+/).sort(),
                                                                                                                    f = 0; f < p.length; f++)p[f].length > 0 && null === o.exec(p[f]) && (h += "." + p[f]);
